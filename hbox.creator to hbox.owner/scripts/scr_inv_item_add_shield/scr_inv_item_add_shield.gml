...
var item_param_0 = "plank shield", //name
		item_param_1 = spr_wood_shield, //sprite
		item_param_2 = scr_shield_state, //state
		item_param_3 = 1, //stat A (damage/ effectiveness)
		item_param_4 = 1, //stat B (stam cost)
		item_param_5 = noone, // special quality (fire/ piercing/ whatever)
		item_param_6 = scr_set_sprite_inventory_shield; //sprite set script
