...
if inv_clothes[3, 0] != noone {
	inv_clothes_temp_0 = inv_clothes[3, 0];
	inv_clothes_temp_1 = inv_clothes[3, 1];
	inv_clothes_temp_2 = inv_clothes[3, 2];
	inv_clothes_temp_3 = inv_clothes[3, 3];
	inv_clothes_temp_4 = inv_clothes[3, 4];
	inv_clothes_temp_5 = inv_clothes[3, 5];
	inv_clothes_temp_6 = inv_clothes[3, 6];
}

//equip clothes to slot
inv_clothes[3, 0] = inv[inv_gui_select, 0];

inv_clothes[3, 1] = inv[inv_gui_select, 1];

inv_clothes[3, 2] = inv[inv_gui_select, 2];

inv_clothes[3, 3] = inv[inv_gui_select, 3];

inv_clothes[3, 4] = inv[inv_gui_select, 4];

inv_clothes[3, 5] = inv[inv_gui_select, 5];

inv_clothes[3, 6] = inv[inv_gui_select, 6];

//update inventory slots
scr_inv_slots_add(inv_clothes[3, 4])
