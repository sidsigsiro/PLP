...
var item_param_0 = "rune stone", //name
		item_param_1 = spr_heal_stone, //sprite
		item_param_2 = scr_heal_state, //state
		item_param_3 = 100, //stat A (damage/ effectiveness)
		item_param_4 = 100, //stat B (max heal energy)
